// soruce: https://github.com/wei756/Everywak/tree/main/src/common/Components/VideoContentPlayer
...
import HlsModule from './modules/HlsModule';
...
function VideoContentPlayer ({ 
  ...
  useEffect(() => {
    ...
    if (mediaType === 'twitchLive') {
      ...
      const embed = <HlsModule videoId={mediaId} handlers={_handlers} />;
      setPlayerEmbed(embed);
    }
  }, [mediaType, mediaId]);
    ...
    if (player) {
      try{
        ...
        onChangeState({
          target: {
            name: 'duration',
            value: ['youtubeVideo', 'hls', 'video'].includes(mediaType) ? player.getDuration() : 0,
          }
        });
